...
typedef enum
{
    QSPI0_CLK_P20_11 = 0x0000,
    QSPI0_CLK_P20_13 = 0x0001,
    QSPI1_CLK_P10_2 = 0x0100,
    QSPI1_CLK_P11_6 = 0x0101,
    QSPI2_CLK_P15_3 = 0x0202,
    QSPI2_CLK_P15_6 = 0x0203,
    QSPI2_CLK_P15_8 = 0x0204,
    QSPI3_CLK_P02_7 = 0x0300,
    QSPI3_CLK_P22_3 = 0x0304,
    QSPI3_CLK_P33_11 = 0x0305,
...
typedef enum
{
    ...
    QSPI3_MISO_P33_13 = 0x0303,
    QSPI3_MISO_P22_1 = 0x0304,
...
typedef enum
{
    ...
    QSPI3_MOSI_P02_6 = 0x0300,
    QSPI3_MOSI_PP10_6 = 0x0301,
    QSPI3_MOSI_P22_0 = 0x0302,
    QSPI3_MOSI_P33_12 = 0x0305,
...
typedef enum
{
    ...
    QSPI3_CS_P02_2 = 0x0303,
    QSPI3_CS_P02_3 = 0x0304,
    QSPI3_CS_P02_8 = 0x0305,
    QSPI3_CS_P00_8 = 0x0306,
    QSPI3_CS_P00_9 = 0x0307,
    QSPI3_CS_P10_5 = 0x0308,
    QSPI3_CS_P33_10 = 0x030B,
    QSPI3_CS_P22_2 = 0x030C,
    QSPI3_CS_P23_1 = 0x030D,
} QSPI_CS_t;
